...
/**
* @param {Uint32Array} pub_input
* @param {Uint8Array} proof
*/
export function verify(pub_input, proof) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray32ToWasm0(pub_input, wasm.__wbindgen_malloc);
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_log_0ef2077b0192fe75 = function(arg0, arg1) {
...
async function __wbg_init(input, maybe_memory) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('hammster2_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
